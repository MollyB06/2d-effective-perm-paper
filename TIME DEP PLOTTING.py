################### TIME DEPENDENT PLOTTING CODE
#generates flux vs time and absolute and relative error vs time plots for two different membrane permeabilties
#need to run both time dependent with EM and time dependent without EM for both eps values to generate data first
...
hom_flux_above_listlong=np.genfromtxt('hom_flux_above_array_long_1').tolist()
hom_flux_below_listlong=np.genfromtxt('hom_flux_below_array_long_1').tolist()
...
EM_flux_above_list = np.genfromtxt('EM_flux_above_array_1').tolist()
EM_flux_below_list =np.genfromtxt('EM_flux_below_array_1').tolist()
...
hom_flux_above_listlong2=np.genfromtxt('hom_flux_above_array_long_2').tolist()
hom_flux_below_listlong2=np.genfromtxt('hom_flux_below_array_long_2').tolist()
...
EM_flux_above_list2 = np.genfromtxt('EM_flux_above_array_2').tolist()
EM_flux_below_list2 =np.genfromtxt('EM_flux_below_array_2').tolist()
...
# Save figure
fig.tight_layout()
fig.savefig('flux_vs_timedashed.eps', bbox_inches='tight', dpi=500)
plt.close()
...
fig.tight_layout()
fig.savefig('abs_flux_errornoinset.eps', bbox_inches='tight', dpi=500)
plt.close()
